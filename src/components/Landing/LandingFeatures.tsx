    ...
    <section ref={sectionRef} className="py-20 px-4 bg-[#F5F8FA]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center">
          <p className="font-playfair italic font-bold text-[#0F1117] text-2xl md:text-3xl lg:text-4xl leading-[2.2]">
            {["Most", "tools", "go", "wide.", "We're", "going", "deep", "—", "into", "how", "ads", "actually", "land", "in", "different", "cultures."].map((word, index) => (
              <span 
                key={index}
                className="inline-block hover:bg-gradient-to-r hover:from-[#5A5CFF] hover:to-[#00C9A7] hover:bg-clip-text hover:text-transparent hover:scale-110 transition-all duration-300 px-1"
              >
                {word}
              </span>
            ))}
