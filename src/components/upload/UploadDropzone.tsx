...
export default function UploadDropzone({
  ...
  return (
    <div
      ...
      className={clsx(
        "w-full h-full min-h-[180px] relative flex flex-col items-center justify-center border border-gray-300 transition-all duration-150 text-center rounded-2xl px-3 py-12 bg-white mb-10 cursor-pointer",
